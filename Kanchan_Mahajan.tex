...
\cvsection{Profile}
\begin{flushleft}
Enthusiastic Application Develper eager to contribute to team success through hard work attention to detail and excellent organizational skills. Experience of Application Develpment and Simulation Data handling using python and .NET Framework. Motivated to work, learn, grow and excel in organization.
\end{flushleft}
\begin{comment}
...
\item Using python to create Winforms GUI 
...
\item Creation of compile toolchain for above written applications.
\item Creating and maintaining various test scenarios.
...
\begin{itemize}
\item Implementing translation mechanism for already existing GUIs. 
\item Developing standard Winforms GUI element library so that developers can leverage the creation GUI easily and quickly.
...
\cvsection{Education}
\cvevent{Masters in Advanced Computational Mechanical}{Technische Hochschule Ingolstadt, Germany}{Sept 2012 -- Dec 2014}{}

\divider

\cvevent{Bachelors in Mechanical Engineering}{Veermata Jijabai Technological Institute, Mumbai, India}{Jun 2005 -- April 2009}{}
