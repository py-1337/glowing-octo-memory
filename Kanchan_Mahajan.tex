...
\definecolor{AffinidiBlue}{HTML}{363b98}
...
% \colorlet{name}{black}
\colorlet{tagline}{AffinidiBlue}
\colorlet{heading}{AffinidiBlue}
\colorlet{headingrule}{AffinidiBlue}
% \colorlet{subheading}{PastelRed}
\colorlet{accent}{AffinidiBlue}
...
\item Coupling different sofwares to create seamless automation, either using containerization or direct coupling using file interfacing.  
...
\end{itemize}
\divider
\cvevent{Python Developer - Intern}{CADFEM GmbH}{Sep 2012--Dec 2014}{}
\begin{itemize}
...
\cvachievement{\faCode}{Programming Languages}{Python, Javascript, Typescript, HTML, CSS, YAML,C\verb|#| }
\cvachievement{\faBoxes}{Orchestration}{Terraform, Ansible, Kubernetes}
\cvachievement{\faDocker}{Docker}{docker-compose}
\cvachievement{\faTerminal}{Scripting}{bash,  powershell}
...
\begin{itemize}
\item Managing home server using Ansible
\item Fictional books
\item Bouldering
\item Wine tasting
\end{itemize}
